...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.Text", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.Comment", b =>
                {
                    b.HasOne("BlazorBoilerplate.Infrastructure.Storage.DataModels.Course", "Course")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("BlazorBoilerplate.Infrastructure.Storage.DataModels.QuizItem", b =>
                {
                    b.HasOne("BlazorBoilerplate.Infrastructure.Storage.DataModels.Quiz", "Quiz")
                        .WithMany("Items")

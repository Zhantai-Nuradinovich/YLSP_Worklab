...
namespace BlazorBoilerplate.Storage
{
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private const string coordinatorRoleName = DefaultRoleNames.Coordinator;
        ...
        private async Task SeedDemoDataAsync()
        {
            if ((await _userManager.FindByNameAsync(DefaultUserNames.User)) == null)
            {
                ...
                await CreateUserAsync(DefaultUserNames.User, "User123456", DefaultRoleNames.User, "Blazor", "User Blazor", "user@blazoreboilerplate.com", "+1 (123) 456-7890", new string[] { userRoleName });

                await EnsureRoleAsync(coordinatorRoleName, "Default coordinator", new string[] { });
                await CreateUserAsync(DefaultUserNames.Coordinator, "Coordinator123456", DefaultRoleNames.Coordinator, "Blazor", "Coordinator Blazor", "coord@blazoreboilerplate.com", "+1 (123) 456-7890", new string[] { coordinatorRoleName });
        ...
        public async Task EnsureAdminIdentitiesAsync()
        {
            ...
            await CreateUserAsync(DefaultUserNames.Administrator, "Admin123456", "Admin", "Blazor", DefaultRoleNames.Administrator, "admin@blazoreboilerplate.com", "+1 (123) 456-7890", new string[] { DefaultRoleNames.Administrator });
